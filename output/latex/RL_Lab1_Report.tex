...
\begin{center}\includegraphics[width=\linewidth]{../../logs/training_curve_1200k.png}\end{center}

{\small 圖 3．0 至 120 萬局完整訓練收斂曲線（每點為 2,000 局區間均分），涵蓋 100k 基礎要求、500k 中期、1M 里程碑與 1.2M 最終收斂。資料源自逐局訓練紀錄，呈現動態學習歷程。\par}
...
{\small 棋盤沿用 sample 的 4-bit 格子，上限為 32768；若候選移動生成 65536，程式會明確停止而非靜默溢位。延伸實驗進一步將兩者訓練至 120 萬局（含 100 萬局里程碑），兩版評估平均分數均翻倍突破 8.3 萬分，2048 勝率全面跨越 90\%（TD-state 達 92.5\%、TD-after-state 達 90.3\%），且 8192 達成率達 36\% 以上，印證長期訓練能充分發揮 4 組 6-tuple 之表徵潛力（詳見 logs/results\_1200k.md 與 README.md）。\par}
